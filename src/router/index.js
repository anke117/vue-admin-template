 ...
 * meta : {
    ...
    noCache: true                // (默认 false)如果设置为true，则不会被 <keep-alive> 缓存
    breadcrumb: false            // (默认 true)如果设置为false，则不会在breadcrumb面包屑中显示
    affix: true                  // (默认 false)如果设置为true，它则会固定在tags-view中
